...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 160" width="100%">
  <defs>
    <linearGradient id="hg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <stop offset="50%"  stop-color="#0a3d55"/>
      <stop offset="100%" stop-color="#0d1117"/>
    </linearGradient>
    <!-- wave path top -->
    <clipPath id="wc">
      <path d="M0,0 L900,0 L900,120 Q675,160 450,130 Q225,100 0,140 Z"/>
    </clipPath>
  </defs>
  <!-- background -->
  <rect width="900" height="160" fill="url(#hg)"/>
  <!-- subtle grid lines -->
  <g stroke="#58a6ff" stroke-opacity="0.04" stroke-width="1">
    ...
    <line x1="750" y1="0" x2="750" y2="160"/>
  </g>
  <!-- accent dot cluster left -->
  <circle cx="60"  cy="50"  r="2" fill="#58a6ff" opacity="0.5"/>
  <circle cx="80"  cy="30"  r="1.5" fill="#58a6ff" opacity="0.3"/>
  <circle cx="40"  cy="80"  r="1" fill="#58a6ff" opacity="0.4"/>
  <!-- accent dot cluster right -->
  <circle cx="840" cy="50"  r="2" fill="#58a6ff" opacity="0.5"/>
  <circle cx="860" cy="30"  r="1.5" fill="#58a6ff" opacity="0.3"/>
  <circle cx="820" cy="80"  r="1" fill="#58a6ff" opacity="0.4"/>
  <!-- wave shape bottom -->
  <path d="M0,130 Q225,100 450,128 Q675,156 900,118 L900,160 L0,160 Z" fill="#0d1117" opacity="0.6"/>
  <!-- thin accent line -->
  <line x1="320" y1="105" x2="580" y2="105" stroke="#58a6ff" stroke-width="0.5" opacity="0.4"/>
  <!-- name -->
  <text x="450" y="68" font-family="Georgia,serif" font-size="42" font-weight="bold"
        fill="#e6f1ff" text-anchor="middle" letter-spacing="2">Abdul Mukit</text>
  <!-- subtitle -->
  <text x="450" y="92" font-family="monospace" font-size="14"
        fill="#58a6ff" text-anchor="middle" letter-spacing="3">Researcher  &amp;  AI/ML Engineer</text>
  <!-- micro tagline -->
  <text x="450" y="112" font-family="monospace" font-size="9"
        fill="#8b949e" text-anchor="middle" letter-spacing="1">PhD / MS Scholarship Candidate  ·  Data Science  ·  Machine Learning  ·  NLP  ·  Generative AI</text>
</svg>
...
```
  Machine Learning  ·  NLP  ·  Generative AI  ·  LLMs  ·  Computer Vision  ·  Sports Analytics  ·  MLOps
```

[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/abdulmukitds/)&nbsp;
[![Gmail](https://img.shields.io/badge/Email-D14836?style=flat-square&logo=gmail&logoColor=white)](https://mail.google.com/mail/?view=cm&to=Ab.mukit.ds@gmail.com)&nbsp;
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?style=flat-square&logo=whatsapp&logoColor=white)](https://wa.me/8801746393598)&nbsp;
[![Portfolio](https://img.shields.io/badge/Portfolio-0d1117?style=flat-square&logo=githubpages&logoColor=58a6ff)](https://mukit-ds.github.io)&nbsp;
![Profile Views](https://komarev.com/ghpvc/?username=mukit-ds&style=flat-square&color=58a6ff&label=Profile+Views)
...
<tr>
<td width="20%" valign="top">
  <sub><b>Dec 2025 — Jan 2026</b></sub><br/>
  <sup>Remote · UAE</sup><br/><br/>
  <img src="https://img.shields.io/badge/Project-based-58a6ff?style=flat-square"/>
</td>
<td valign="top">

**AI Engineer — Marrfa Discovery Real Estate LLC**

- Developed a **RAG-based AI chatbot** to handle natural language user queries and dynamically filter property listings by specified criteria

`RAG` &nbsp; `LangChain` &nbsp; `LLMs` &nbsp; `Chatbot Development`
...
**AI/ML Engineer — KodeEnd IT Solutions AB**

- Designed and developed an **ML-based sports outcome prediction model achieving 85% accuracy**, deployed for real-time production use
- Built and optimised an **object detection pipeline** using computer vision techniques for automated visual recognition
- Managed the full ML pipeline: data collection → preprocessing → feature engineering → model training → production deployment → MLOps monitoring
- Applied best practices including version control, iterative model improvement, and scalable deployment strategies

`TensorFlow` &nbsp; `Scikit-learn` &nbsp; `Computer Vision` &nbsp; `MLOps` &nbsp; `Python`
...
| # | Project | Description | Stack | Links |
|---|---------|-------------|-------|-------|
| 05 | **AI Interview Coach** | Job-fit scoring via TF-IDF & semantic embeddings; personalised cover letter generation | `NLP` `Cosine Similarity` `Streamlit` | [GitHub ↗](https://github.com/mukit-ds/Resume_Advisor_Bot) · [Demo ↗](https://www.youtube.com/watch?v=0bi5QerI0Pc) |
| 06 | **Sentiment Analysis Engine** | LSTM + Transformer real-time multi-class emotion classifier with attention mechanisms | `LSTM` `Transformers` `NLP` | [GitHub ↗](https://github.com/mukit-ds/SentimentAnalysis) · [Live ↗](https://sentimentanalysis-6ne7g5gzk8cxvkb5rduv2u.streamlit.app/) |
| 07 | **Email Spam Classifier** | Ensemble-based binary classifier — *95%+ accuracy* with advanced text preprocessing | `NLP` `Ensemble Learning` `Streamlit` | [GitHub ↗](https://github.com/mukit-ds/EmailSpamClassifier) · [Live ↗](https://emailspamclassifier-fx2ax7w2we4gb7qm74iwkb.streamlit.app/) |
| 08 | **Customer Churn Prediction** | Gradient boosting model for proactive at-risk customer identification | `XGBoost` `Feature Engineering` `Classification` | [GitHub ↗](https://github.com/mukit-ds/CustomerCurnPrediction) |
| 09 | **Customer Segmentation & Clustering** | K-Means + RFM analysis revealing actionable customer personas for targeted marketing | `K-Means` `RFM` `Scikit-learn` | [GitHub ↗](https://github.com/mukit-ds/CustomerSegmentation) |
| 10 | **Movie Recommendation Engine** | Content-based recommender using TF-IDF & cosine similarity — *88%+ accuracy* | `TF-IDF` `Cosine Similarity` `Streamlit` | [GitHub ↗](https://github.com/mukit-ds/MovieRecommendedSystem) · [Demo ↗](https://www.linkedin.com/posts/abdulmukitds_machinelearning-datascience-recommendationsystem-activity-7214523660957622272-NpJA/) |
...
<img height="165em" src="https://github-readme-stats.vercel.app/api?username=mukit-ds&show_icons=true&theme=github_dark&include_all_commits=true&count_private=true&hide_border=true&bg_color=0d1117&title_color=58a6ff&icon_color=58a6ff&text_color=c9d1d9"/>
&nbsp;
<img height="165em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=mukit-ds&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=c9d1d9&langs_count=8"/>

</div>

<div align="center">

[![GitHub Streak](https://streak-stats.demolab.com?user=mukit-ds&theme=github-dark-blue&hide_border=true&background=0d1117&stroke=30363d&ring=58a6ff&fire=58a6ff&currStreakLabel=58a6ff&sideLabels=8b949e&dates=8b949e&currStreakNum=c9d1d9&sideNums=c9d1d9)](https://git.io/streak-stats)
...
| Qualification | Institution | Period | Focus Areas |
|--------------|-------------|--------|-------------|
...
| Issuing Body | Certification | Date | Credential |
|-------------|--------------|------|-----------|
| **British Airways** | Data Science Job Simulation | Sep 2024 | [Verify ↗](https://bit.ly/CertificateBritishAirways) |
| **IBM** | Python for Data Science, AI & Development | Dec 2023 | [Verify ↗](https://bit.ly/CertificateDSCoursera) |
| **IBM** | Tools for Data Science | Nov 2023 | [Verify ↗](https://bit.ly/4w3BSQv) |
| **IBM** | What is Data Science? | Sep 2023 | [Verify ↗](https://bit.ly/4u4yfYD) |
| **CAJRA** | Workshop on Research and Publication | Nov 2022 | — |
...
| Channel | |
|---------|--|
| **Email** | [Ab.mukit.ds@gmail.com](https://mail.google.com/mail/?view=cm&to=Ab.mukit.ds@gmail.com) |
| **LinkedIn** | [linkedin.com/in/abdulmukitds](https://www.linkedin.com/in/abdulmukitds/) |
| **WhatsApp** | [+880 1746-393598](https://wa.me/8801746393598) |
| **Portfolio** | [mukit-ds.github.io](https://mukit-ds.github.io) |
| **GitHub** | [github.com/mukit-ds](https://github.com/mukit-ds) |
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 80" width="100%">
  ...
  <path d="M0,40 Q225,0 450,30 Q675,60 900,10 L900,80 L0,80 Z" fill="url(#fg)"/>
  <line x1="320" y1="58" x2="580" y2="58" stroke="#58a6ff" stroke-width="0.4" opacity="0.35"/>
  <text x="450" y="72" font-family="monospace" font-size="9" fill="#8b949e"
        text-anchor="middle" letter-spacing="1">Remote-First · Open to PhD / MS Scholarship · Research Collaborations Welcome</text>
</svg>
